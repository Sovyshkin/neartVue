...
export interface ApiArtworkArtwork extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u041C\u043E\u0434\u0435\u043B\u044C \u043A\u0430\u0440\u0442\u0438\u043D\u044B \u0441 \u0434\u043E\u043F\u043E\u043B\u043D\u0438\u0442\u0435\u043B\u044C\u043D\u043E\u0439 \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u0435\u0439';
    displayName: '\u041A\u0430\u0440\u0442\u0438\u043D\u0430';
    pluralName: 'artworks';
  ...
  attributes: {
    aboutArtwork: Schema.Attribute.Text &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deliveryInfo: Schema.Attribute.Text &
      Schema.Attribute.Configurable &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    status_art: Schema.Attribute.Enumeration<
      [
        '\u0412 \u043D\u0430\u043B\u0438\u0447\u0438\u0438',
        '\u041D\u0435\u0442 \u0432 \u043D\u0430\u043B\u0438\u0447\u0438\u0438',
        '\u0414\u043E\u0441\u0442\u0443\u043F\u043D\u043E \u043F\u043E\u0434 \u0437\u0430\u043A\u0430\u0437',
    ...
    >;
    storageConditions: Schema.Attribute.Text &
      Schema.Attribute.Configurable &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    unique_value: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCartItemCartItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Items in user cart';
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer orders for artworks';
    displayName: '\u0417\u0430\u043A\u0430\u0437';
    pluralName: 'orders';
    singularName: 'order';
  };
  ...
  attributes: {
    ...
    cdekOrderUuid: Schema.Attribute.String;
    cdekPvzAddress: Schema.Attribute.Text;
    cdekPvzCode: Schema.Attribute.String;
    cdekTrackNumber: Schema.Attribute.String;
    ...
    deliveryMethod: Schema.Attribute.Enumeration<
      ['courier', 'pickup', 'cdek_pvz', 'cdek_courier']
    > &
    ...
    paymentMethod: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'tinkoff'>;
...
export interface ApiTicketResponseTicketResponse
  extends Struct.CollectionTypeSchema {
  collectionName: 'ticket_responses';
  info: {
    description: 'Responses to support tickets';
    displayName: 'Ticket Response';
    pluralName: 'ticket-responses';
    singularName: 'ticket-response';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ticket-response.ticket-response'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u041E\u0442\u043A\u0440\u044B\u0442'>;
    text: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    isArtist: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    isVerified: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    kartinas: Schema.Attribute.Relation<'oneToMany', 'api::artwork.artwork'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ticket-response.ticket-response': ApiTicketResponseTicketResponse;
